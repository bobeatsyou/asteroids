...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        if self.radius <= ASTEROID_MIN_RADIUS:
            ...
            new_asteroid1 = Asteroid(self.position.x, self.position.y, new_radius, *self.groups())
            new_asteroid2 = Asteroid(self.position.x, self.position.y, new_radius, *self.groups())
